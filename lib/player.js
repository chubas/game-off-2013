Class('Player')({
    ...
    prototype : {
        ...
        kills : function(entity) {
            return this.faction === entity.faction && !entity.damaging;
        },

        draw : function(context) {
            // var color = new Color(this.color).iluminateBy(20).toHTML();
            // var color = new Color(this.color).obscureBy(20).toHTML();
