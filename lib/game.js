...
var pallette = PALLETTES[2].slice(0, 3);
...
Class('Game').includes(TimeLapseSupport, CustomEventSupport)({
    ...
    prototype : {
        ...
        _mainLoop : function() {
            ...
            game._ctx.fillStyle = new Chameleon(game.player.color).setValue(5).toHTML();
        ...
        _playerAction : function() {
            if(!this._playerActionCooldown) {
                ...
                console.log("THIS PLAYER COLOR", this.player.color);
