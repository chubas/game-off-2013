Class('Game').includes(TimeLapseSupport)({
    ...
    prototype : {
        ...
        _collide : function(sprite1, sprite2) {
            ...
            var matchesX = function() {
                if(box1[0] < box2[0]) { // box1 is most left
                    if(box2[0] < box1[2]) {
                        return true;
                    }
                } else {
            ...
            var matchesY = function() {
                if(box1[1] < box2[1]) { // box1 is uppermost
                    if(box2[1] < box1[3]) {
                        return true;
                    }
                } else {
            ...
            // TODO: Simplify booleans instead of functions
        ...
        _mainLoop : function() {
            ...
            game._sprites.forEach(function(sprite, index) {
                ...
                if(game._collide(game.player, sprite)) {
