...
Class('Game').includes(TimeLapseSupport, CustomEventSupport)({
    ...
    prototype : {
        ...
        _mainLoop : function() {
            ...
            // console.log("Advancing", scrollSpeed, game._tick, game._sprites.length);
            ...
            // if(window.bgMusic) {
            // console.log(
            //     window.bgMusic.getPosition(),
            //     game._tick - 60,
            //     bgMusic.getPosition() / (game._tick - 60));
            // }
        ...
        _prepareKeyListeners : function() {
            ...
            document.body.addEventListener('keydown', function(event) {
                if(event.keyCode === 84) {
                    // if(window.lastTick) {
                    //     if(window.bpm) {
                    //         console.log("TICK!", game._tick, game._tick - window.lastTick);
                    //         window.bpm = (window.bpm + (game._tick - window.lastTick)) / 2;
                    //     } else {
                    //         window.bpm = game._tick - window.lastTick;
                    //     }
                    //     window.lastTick = game._tick;
                    // } else {
                    //     window.lastTick = game._tick;
                    // }
        ...
        _increaseScore : function _increaseScore() {
            ...
            this.score = this.score + (1000 * this.chainScoreMultiplier);
